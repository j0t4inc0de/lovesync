...
## 2. Armonía en Nuestra Comunidad y Normas de Contenido (UGC)
Aunque las bitácoras y fotografías de cada pareja son completamente privadas, para cumplir con los estándares globales de seguridad obligatorios de **Apple App Store** y **Google Play Store** relativos a plataformas con Contenido Generado por el Usuario (UGC) almacenado en la nube, todos los usuarios se comprometen a respetar las siguientes normas de convivencia:

1. **Respeto Mutuo y No Acoso:** Queda estrictamente prohibido utilizar notas, títulos o descripciones para ejercer hostigamiento, intimidación, discursos de odio o agresiones verbales contra la pareja o terceros en los apartados comunitarios.
2. **Legalidad y Contenido Adecuado:** No está permitida la carga o transmisión a nuestros servidores en Cloudflare R2 de material ilícito, violento, o pornografía no consentida (*revenge porn*).
3. **Protección del Ecosistema:** Nos reservamos el derecho de suspender o remover la cuenta y el acceso a la nube de cualquier usuario que incurra en violaciones flagrantes y reiteradas a estas normas de respeto y dignidad, sin derecho a reembolso.
...
## 4. Desvinculación Autónoma (`unpair`)
El emparejamiento entre los dos dispositivos de la pareja se sustenta en el mutuo acuerdo y consentimiento. Cualquiera de las partes puede ejercer su derecho a la desvinculación autónoma (`unpair`) desde la configuración de su perfil en cualquier momento. Al realizarlo:
* Cesa de inmediato la sincronización cruzada en tiempo real de nuevas citas entre ambos teléfonos.
* Los registros fotográficos previamente cargados al servidor en Cloudflare R2 permanecen en el historial de la bitácora hasta que alguno de los usuarios decida eliminarlos expresamente.
